...
export interface YamlMappingItem extends YamlNode, MappingItem {
...
export interface YamlDocument extends NodeProvider {
...
export class YamlLocator {
     ...
     * @returns the search results of yaml elements at the given position
     */
